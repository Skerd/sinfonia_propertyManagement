...
type Props = WithLanguageType &
    WithAxiosType<ProjectDocument, RejectPayload> & {
        open: boolean;
        onClose: () => void;
...
function RejectProjectDocumentDialog({
    projectDocument,
    open,
    onClose,
    resolveLanguageKey,
...
export default compose(
    withLanguage("src/modules/propertyManagement/components/custom/projectDocuments/rejectProjectDocumentDialog.tsx"),
    withAxios(
        {
            method: "POST",
            url:    "/api/realEstate/projectDocument/reject",
            data:   {},
        },
        true,
    ),
