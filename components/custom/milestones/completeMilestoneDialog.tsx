...
type CompleteMilestoneDialogProps = WithLanguageType &
...
export default compose(
    withLanguage("src/modules/propertyManagement/components/custom/milestones/completeMilestoneDialog.tsx"),
    withAxios(
        {
            method: "POST",
            url:    "/api/realEstate/milestone/complete",
            data:   {},
        },
        true,
    ),
