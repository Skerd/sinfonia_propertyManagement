...
type CancelMilestoneDialogProps = WithLanguageType &
...
export default compose(
    withLanguage("src/modules/propertyManagement/components/custom/milestones/cancelMilestoneDialog.tsx"),
    withAxios(
        {
            method: "POST",
            url:    "/api/realEstate/milestone/cancel",
            data:   {},
        },
        true,
    ),
