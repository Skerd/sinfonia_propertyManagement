...
type CancelScheduleTaskDialogProps = WithLanguageType &
...
function CancelScheduleTaskDialog({
    scheduleTask,
    open,
    onClose,
    resolveLanguageKey,
            ...
            <DialogContent className="max-w-lg" onClick={(e) => e.stopPropagation()}>
                ...
                <DialogFooter>
                    ...
                    <Button type="button" variant="destructive" onClick={handleSubmit} disabled={loading}>
                        {loading ? <LoaderCircle className="animate-spin h-4 w-4" /> : <XCircle className="h-4 w-4" />}
...
export default compose(
    withLanguage("src/modules/propertyManagement/components/custom/scheduleTasks/cancelScheduleTaskDialog.tsx"),
    withAxios(
        {
            method: "POST",
            url:    "/api/realEstate/scheduleTask/cancel",
            data:   {},
        },
        true,
    ),
    withDebug(true, true, "scheduletasks"),
)(CancelScheduleTaskDialog);
