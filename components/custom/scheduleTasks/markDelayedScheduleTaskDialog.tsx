...
type MarkDelayedScheduleTaskDialogProps = WithLanguageType &
...
function MarkDelayedScheduleTaskDialog({
    scheduleTask,
    open,
    onClose,
    resolveLanguageKey,
    ...
    onSuccess = () => {},
    loading,
}: MarkDelayedScheduleTaskDialogProps) {
...
export default compose(
    withLanguage("src/modules/propertyManagement/components/custom/scheduleTasks/markDelayedScheduleTaskDialog.tsx"),
    withAxios(
        {
            method: "POST",
            url:    "/api/realEstate/scheduleTask/markDelayed",
            data:   {},
        },
        true,
    ),
    withDebug(true, true, "scheduletasks"),
)(MarkDelayedScheduleTaskDialog);
