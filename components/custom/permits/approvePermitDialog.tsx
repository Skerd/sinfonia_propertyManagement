...
function ApprovePermitDialog({
    ...
    const handleSubmit = (values: StatusChangeValues) => {
        onFilterChange({_id: permit._id, notes: values.notes, expiresAt: values.expiresAt});
    };
...
export default compose(
    withLanguage("src/modules/propertyManagement/components/custom/permits/approvePermitDialog.tsx"),
    withAxios(
        {
            method: "POST",
            url: "/api/realEstate/permit/approve",
            data: {},
        },
        true,
    ),
