...
export const ADD_DUE_DILIGENCE_STEP_LAND_PARCEL_ACTION = "addDueDiligenceStep";
...
function Action({onAction, landParcel, resolveLanguageKey}: Props) {
    ...
    if (!can) return null;
    return (
        <DropdownMenuItem onClick={() => {onAction(ADD_DUE_DILIGENCE_STEP_LAND_PARCEL_ACTION);}}>
            <ListPlus className="text-primary" size={16} />
...
export default compose(
    withLanguage("src/modules/propertyManagement/clients/panel/private/landParcels/center/actions/addDueDiligenceStep.tsx"),
