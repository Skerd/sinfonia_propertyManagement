...
import {editWarrantyFormSchema} from "armonia/src/modules/propertyManagement/api/realEstate/private/warranty/editWarranty.form.validator.ts";
import type {Warranty} from "armonia/src/modules/propertyManagement/api/realEstate/private/warranty/warranty.dto.ts";
import type {EditWarrantyFormType} from "armonia/src/modules/propertyManagement/api/realEstate/private/warranty/warranty.schema-def.ts";

export default createGenericEditPage<Warranty, EditWarrantyFormType>({
    languagePath: "src/modules/propertyManagement/clients/panel/private/warranties/editWarranty.tsx",
    model: "warranties",
    apiUrl: "/api/realEstate/warranty",
    schema: editWarrantyFormSchema,
    mapEntityData: (data) => ({
        ...data,
        ...
        retentionReleaseDate: (data as any).retentionReleaseDate ? new Date((data as any).retentionReleaseDate).toISOString().split("T")[0] : undefined,
