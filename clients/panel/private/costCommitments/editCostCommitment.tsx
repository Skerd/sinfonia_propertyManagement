...
import {editCostCommitmentFormSchema} from "armonia/src/modules/propertyManagement/api/realEstate/private/costCommitment/editCostCommitment.form.validator.ts";
...
import type {EditCostCommitmentFormType} from "armonia/src/modules/propertyManagement/api/realEstate/private/costCommitment/costCommitment.schema-def.ts";

export default createGenericEditPage<CostCommitment, EditCostCommitmentFormType>({
    languagePath: "src/modules/propertyManagement/clients/panel/private/costCommitments/editCostCommitment.tsx",
    model: "costcommitments",
    apiUrl: "/api/realEstate/costCommitment",
    schema: editCostCommitmentFormSchema,
    mapEntityData: (data) => ({
        ...data,
        ...
        issuedAt: (data as any).issuedAt ? new Date((data as any).issuedAt).toISOString().split("T")[0] : undefined,
