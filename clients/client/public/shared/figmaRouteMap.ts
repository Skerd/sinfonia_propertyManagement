...
export const figmaPublicRoutes: FigmaPublicRoute[] = [
    ...
    {path: "/project/3d", label: "Open project - 3D", nodeId: "467:685", frameName: "Open project - 3D", height: 1117},
    {path: "/project/3d/floor", label: "Open project - 3D Click floor", nodeId: "543:611", frameName: "Open project - 3D Click floor", height: 1117},
    {path: "/project/gallery", label: "Open project - Gallery", nodeId: "472:997", frameName: "Open project - Gallery", height: 1117},
    {path: "/project/finance", label: "Open project - Finance", nodeId: "475:1240", frameName: "Open project - Finance", height: 1117},
