...
export const PROJECT_UNIT_STATUS_FILTERS = ["available", "sold", "reserved", "unavailable", "all"] as const;
...
/** Syncs Available / Sold / Reserved / Unavailable / All across polygon viewer + Units grid via `unitStatus` URL param. */
